...
class KotaController extends Controller
{
    ...
    {
        $request->validate([
            'nama_kota' => 'required|unique:kotas|max:15'
        ], [
            'nama_kota.required' => 'Nama Kota Tidak Boleh Kosong',
            'nama_kota.unique' => 'Nama Kota Tidak Boleh Sama',
            'nama_kota.max' => 'Nama Kota max 20 Karakter',
        ]);
    ...
    {
        $request->validate([
            'nama_kota' => 'required|unique:kotas|max:20'
        ], [
            'nama_kota.required' => 'Nama Kota Tidak Boleh Kosong',
            'nama_kota.unique' => 'Nama Kota Tidak Boleh Sama',
            'nama_kota.max' => 'Nama Kota max 20 Karakter',
